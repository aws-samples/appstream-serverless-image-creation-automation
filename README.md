...
This repository contains the supporting scripts for the AWS Desktop and Application Streaming blog article [Automatically create customized AppStream 2.0 Windows images](https://aws-blogs-prod.amazon.com/desktop-and-application-streaming/automatically-cr…0-windows-images/). Please refer to the blog article for guidance on deploying the solution. 
